...
<div class="col-md-12">
  <div class="card">
    <div class="card-body">
      <h2 class="card-title">Edit Data Uji</h2>
    </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-5">
            <input type="text" class="form-control @error('sample') is-invalid @enderror" id="sample" name="sample"
              placeholder="Sample" value="{{ $data->sample }}">
            @error('sample')
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-5">
            <input type="text" class="form-control @error('lampu') is-invalid @enderror" id="lampu" name="lampu"
              placeholder="Lampu (lampu)" value="{{ $data->lampu }}">
            @error('lampu')
            <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
            </span>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-5">
            <input type="text" class="form-control @error('tt') is-invalid @enderror" id="tt" name="tt"
              placeholder="TT (cm)" value="{{ $data->tt }}">
            @error('tt')
            <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
            </span>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-5">
            <input type="text" class="form-control @error('jd') is-invalid @enderror" id="jd" name="jd"
              placeholder="JD (lb)" value="{{ $data->jd }}">
            @error('jd')
            <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
            </span>
